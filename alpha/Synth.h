...
struct sEnvelope
{
	...
	sEnvelope(double attackTime, double decayTime, double sustainTime,
			  double releaseTime, double startAmplitute, double sustainAmplitute) :
		dAttackTime(attackTime), dDecayTime(decayTime), dSustainTime(sustainTime),
		dReleaseTime(releaseTime), dStartAmplitude(startAmplitute), dSustainAmplitude(sustainAmplitute) {
	}
};
struct sTone
{
	...
	sTone(eWaveType _type, double startFrequency, double endFrequency, double amplitude) :
		waveType(_type), dStartFrequency(startFrequency), dEndFrequency(endFrequency), dAmplitude(amplitude) {
	}
};
